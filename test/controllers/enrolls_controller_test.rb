...
class EnrollsControllerTest < ActionController::TestCase
  ...
  test "should create enroll" do
    assert_difference('Enroll.count') do
      post :create, enroll: { course_id: @enroll.course_id, lettergrade: @enroll.lettergrade, percentage: @enroll.percentage, string: @enroll.string, student_id: @enroll.student_id }
    end
  ...
  test "should update enroll" do
    patch :update, id: @enroll, enroll: { course_id: @enroll.course_id, lettergrade: @enroll.lettergrade, percentage: @enroll.percentage, string: @enroll.string, student_id: @enroll.student_id }
    assert_redirected_to enroll_path(assigns(:enroll))
  end
